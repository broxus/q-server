...
const BlockAccountBlocksTransactionsArray = array(
...
const BlockMasterPrevBlkSignaturesArray = array(
...
function createResolvers(data: QBlockchainData) {
    return {
        ...
        MsgEnvelope: {
            fwd_fee_remaining(
                parent: { fwd_fee_remaining: string },
                args: BigIntArgs,
            ) {
        ...
        GasLimitsPrices: {
            ...
            special_gas_limit(
                parent: { special_gas_limit: string },
                args: BigIntArgs,
            ) {
        ...
        ConfigP14: {
            basechain_block_fee(
                parent: { basechain_block_fee: string },
                args: BigIntArgs,
            ) {
                return resolveBigUInt(2, parent.basechain_block_fee, args)
            },
            masterchain_block_fee(
                parent: { masterchain_block_fee: string },
                args: BigIntArgs,
            ) {
        ...
        ConfigP18: {
            ...
            mc_bit_price_ps(
                parent: { mc_bit_price_ps: string },
                args: BigIntArgs,
            ) {
                return resolveBigUInt(1, parent.mc_bit_price_ps, args)
            },
            mc_cell_price_ps(
                parent: { mc_cell_price_ps: string },
                args: BigIntArgs,
            ) {
        ...
        TransactionStorage: {
            ...
            storage_fees_due(
                parent: { storage_fees_due: string },
                args: BigIntArgs,
            ) {
        ...
        TransactionCredit: {
            ...
            due_fees_collected(
                parent: { due_fees_collected: string },
                args: BigIntArgs,
            ) {
        ...
        TransactionAction: {
            total_action_fees(
                parent: { total_action_fees: string },
                args: BigIntArgs,
            ) {
                return resolveBigUInt(2, parent.total_action_fees, args)
            },
            total_fwd_fees(
                parent: { total_fwd_fees: string },
                args: BigIntArgs,
            ) {
        ...
        Block: {
            ...
            gen_software_capabilities(
                parent: { gen_software_capabilities: string },
                args: BigIntArgs,
            ) {
...
scalarFields.set("accounts.init_code_hash", {
    type: "string",
    path: "doc.init_code_hash",
})
...
scalarFields.set("transactions.chain_order", {
    type: "string",
...
scalarFields.set("transactions.ext_in_msg_fee", {
    type: "uint1024",
    path: "doc.ext_in_msg_fee",
})
...
scalarFields.set("messages.chain_order", {
    type: "string",
    path: "doc.chain_order",
})
...
scalarFields.set(
    "blocks.account_blocks.transactions.total_fees_other.currency",
    {
        type: "number",
...
scalarFields.set("blocks.chain_order", {
    type: "string",
    path: "doc.chain_order",
})
...
scalarFields.set("blocks.master.config.p32.main", {
    type: "number",
    path: "doc.master.config.p32.main",
})
...
scalarFields.set("blocks.master.config.p33.main", {
    type: "number",
    path: "doc.master.config.p33.main",
})
...
scalarFields.set("blocks.master.config.p34.main", {
    type: "number",
    path: "doc.master.config.p34.main",
})
...
scalarFields.set("blocks.master.config.p35.main", {
    type: "number",
    path: "doc.master.config.p35.main",
})
...
scalarFields.set("blocks.master.config.p36.main", {
    type: "number",
    path: "doc.master.config.p36.main",
})
...
scalarFields.set("blocks.master.config.p37.main", {
    type: "number",
    path: "doc.master.config.p37.main",
})
...
scalarFields.set(
    "blocks.master.shard_hashes.descr.fees_collected_other.currency",
    {
        type: "number",
...
scalarFields.set(
    "blocks.master.shard_hashes.descr.fees_collected_other.value",
    {
        type: "uint1024",
...
scalarFields.set(
    "blocks.master.shard_hashes.descr.funds_created_other.currency",
    {
        type: "number",
...
scalarFields.set("zerostates.accounts.init_code_hash", {
    type: "string",
    path: "doc.accounts[*].init_code_hash",
})
...
scalarFields.set("zerostates.file_hash", {
    type: "string",
    path: "doc.file_hash",
})
...
scalarFields.set(
    "zerostates.master.config.p11.critical_params.max_tot_rounds",
    {
        type: "number",
        path: "doc.master.config.p11.critical_params.max_tot_rounds",
    },
...
scalarFields.set(
    "zerostates.master.config.p11.critical_params.min_tot_rounds",
    {
        type: "number",
        path: "doc.master.config.p11.critical_params.min_tot_rounds",
    },
...
scalarFields.set("zerostates.master.config.p32.main", {
    type: "number",
    path: "doc.master.config.p32.main",
})
...
scalarFields.set("zerostates.master.config.p33.main", {
    type: "number",
    path: "doc.master.config.p33.main",
})
...
scalarFields.set("zerostates.master.config.p34.main", {
    type: "number",
    path: "doc.master.config.p34.main",
})
...
scalarFields.set("zerostates.master.config.p35.main", {
    type: "number",
    path: "doc.master.config.p35.main",
})
...
scalarFields.set("zerostates.master.config.p36.main", {
    type: "number",
    path: "doc.master.config.p36.main",
})
...
scalarFields.set("zerostates.master.config.p37.main", {
    type: "number",
    path: "doc.master.config.p37.main",
})
...
scalarFields.set("zerostates.root_hash", {
    type: "string",
    path: "doc.root_hash",
})
...
joinFields.set("blocks_signatures.block", {
    ...
    canJoin(parent: { _key: string }, args: JoinArgs) {
        return (
            args.when === undefined ||
            BlockSignatures.test(null, parent, args.when)
        )
    },
})
